...
-- Drop retirement_info table and then recreate to include emp_no
...
-- Use left join for retirement_info and dept-emp tables
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
-- Employee count by department number in a new table
